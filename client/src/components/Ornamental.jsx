            ...
            <div>
                ...
                <div className="serviceSection">
                    <div className="serviceLeft">
                        ...
                        <p className="serviceDesc">Pruning of ornamental plants is very similar to pruning of a tree. You want to ensure you are making proper prunes cut versus heading cuts. In order to keep your ornamentals looking good all year round you need to start pruning when they are young and continue to prune them every year until they reach the desired shape and size that you want. Pruning should be done during the winter months when the plant is in it's dormant state. If you prune them during the late summer or fall months the plant will start growing tender new growth that will likely not survive the winter.</p>
